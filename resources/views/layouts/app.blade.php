        ...
        <nav class="bg-primary shadow-md">
            <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
                ...
                <div class="flex items-center gap-6">
                    ...
                    @auth
                        ...
                        <a href="{{ route('posts.create') }}"
                           class="flex items-center bg-secondary hover:bg-accent hover:text-white text-black font-semibold px-4 py-2 rounded-xl transition-all shadow-md hover:shadow-lg">
                ...
                <div class="flex items-center gap-4">
                    ...
                    @else
                        <a href="{{ route('login') }}"
                           class="flex items-center bg-accent hover:bg-primary text-white px-5 py-2 rounded-xl font-semibold transition-all shadow-md hover:shadow-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <a href="{{ route('register') }}"
                           class="flex items-center bg-secondary hover:bg-accent text-black hover:text-white px-5 py-2 rounded-xl font-semibold transition-all shadow-md hover:shadow-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
